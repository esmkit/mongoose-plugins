...
import { getFolderNameFromPath, normalizeSeederName, normalizeSeederFileName } from "../utils/helpers";
...
export default class SeederGenerator {
	...
	_initName(name) {
		...
		this.seederFileRelativePath = path.join(userSeedersFolderName, this.seederFileName);
	}
